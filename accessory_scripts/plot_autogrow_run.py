...
def run_plotter(
    ...
    plt.savefig(outfile, bbox_inches="tight", foramt=params["outfile_format"], dpi=1000)


def print_data_table(infolder: str, folder_list: List[str]) -> Dict[str, Any]:
    """
...
# TODO Rename this here and in `process_inputs`
