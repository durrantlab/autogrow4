...
def generate_figures(params: Dict[str, Any]) -> None:
    ...
    run_boxplot(params, dict_of_similarity_lists,
                outfile + os.sep + "boxplot_of_similarity_for_input_compounds." + params["outfile_format"],
    ...
    run_plotter(params, dict_of_similarity_lists,
                outfile + os.sep + "plotter_of_average_similarities_for_generated_compounds." + params["outfile_format"],
                key_start_with="compound",
    ...
    run_plotter(params, dict_of_efficiency_lists,
                outfile + os.sep + "plotter_of_ligand_efficiency_for_generated_compounds." + params[
                    "outfile_format"],
                key_start_with="compound",
                x_label="New compounds (ID) sorted from the highest to lowest affinity",
