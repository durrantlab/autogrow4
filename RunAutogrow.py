...
PARSER.add_argument('--filter_source_compounds', choices = [True,False,"True","False","true","false"], 
    default=True, help = 'If True source ligands from source_compound_file will be \
