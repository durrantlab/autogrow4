...
AUTOCLICKCHEM_reactions = {
    ...
    "28_Acid_Anhydride_and_Amine":     {
        "reaction_name": "28_Acid_Anhydride_and_Amine",
        "example_rxn_product": "O=C1CN(C(=O)C2CCCCC2)C(=O)O1", 
        "example_rxn_reactants": ["C1CCC(CC1)C(=O)OC(=O)C2CCCCC2", "O=C1CNC(=O)O1"], 
        "functional_groups": ["Acid_Anhydride", "Amine_2R"], 
        "group_smarts": ["[*]C(=O)-O-C([*])=O", "[#7;$([#7&!H3;H2R0X1]-[#6]),$([#7&!H3;H1R1X3](:,-[#6R1]):,-[#6R1,#7R1]),$([#7&!H3;H2]-[#6]),$([#7&!H3;H0R1X2](:,-[#6R1;X3H1]):,-[#6R1X3H1]),$([#7&!H3;H0R1X2](:,-[#6R1;X3]):,-[#7R1X3]),$([#7&!H3;H1R0X3](-[#6])-[#6R0])]"], 
        "num_reactants": 2, 
        "reaction_string": "[*:1]C(=O)-O-C([*:4])=O.[#7;$([#7&!H3;H2R0X1]-[#6]),$([#7&!H3;H1R1X3](:,-[#6R1]):,-[#6R1,#7R1]),$([#7&!H3;H2]-[#6]),$([#7&!H3;H0R1X2](:,-[#6R1;X3H1]):,-[#6R1X3H1]),$([#7&!H3;H0R1X2](:,-[#6R1;X3]):,-[#7R1X3]),$([#7&!H3;H1R0X3](-[#6])-[#6R0]):2]>>[*:1]C(=O)-[#7:2]", 
        "RXN_NUM": 28
        },
    "29_Acid_Anhydride_and_Alcohol":     {
        "reaction_name": "29_Acid_Anhydride_and_Alcohol",
        "example_rxn_product": "O=C(OCCCF)C1CCCCC1", 
        "example_rxn_reactants": ["C1CCC(CC1)C(=O)OC(=O)C2CCCCC2", "FCCC(O)"], 
        "functional_groups": ["Acid_Anhydride", "Alcohol"], 
        "group_smarts": ["[*]C(=O)-O-C([*])=O", "[#6&$([CR0,R1X3,R1X4])&!$([#6](=,-[OR0,SR0])[OR0])]-[OR0&H1]"], 
        "num_reactants": 2, 
        "reaction_string": "[*:1]C(=O)-O-C([*:3])=O.[#6&$([CR0,R1X3,R1X4])&!$([#6](=,-[OR0,SR0])[OR0]):2]-[OR0&H1]>>[*:1]C(=O)-O[#6&$([CR0,R1X3,R1X4])&!$([#6](=,-[OR0,SR0])[OR0]):2]", 
        "RXN_NUM": 29
        },
    "30_Acid_Anhydride_and_Thiol":     {
        "reaction_name": "30_Acid_Anhydride_and_Thiol",
        "example_rxn_product": "O=C([O-])OC(=O)CCSC(=O)C1CCCCC1", 
        "example_rxn_reactants": ["C1CCC(CC1)C(=O)OC(=O)C2CCCCC2", "O=C([O-])OC(=O)CCS"], 
        "functional_groups": ["Acid_Anhydride", "Thiol_1R"], 
        "group_smarts": ["[*]C(=O)-O-C([*])=O", "[#6&$([CR0,R1X3,R1X4])&!$([#6](=,-[OR0,SR0])[SR0])]-[SR0&H1]"], 
        "num_reactants": 2, 
        "reaction_string": "[*:1]C(=O)-O-C([*:3])=O.[#6&$([CR0,R1X3,R1X4])&!$([#6](=,-[OR0,SR0])[SR0]):2]-[SR0&H1]>>[*:1]C(=O)-S[#6&$([CR0,R1X3,R1X4])&!$([#6](=,-[OR0,SR0])[SR0]):2]", 
        "RXN_NUM": 30
        },
    "31_Acid_Anhydride_To_Cyanide":     {
        "reaction_name": "31_Acid_Anhydride_To_Cyanide",
        "example_rxn_product": "N#CC(=O)C1CCCCC1", 
        "example_rxn_reactants": ["C1CCC(CC1)C(=O)OC(=O)C2CCCCC2"], 
        "functional_groups": ["Acid_Anhydride"], 
        "group_smarts": ["[*]C(=O)-O-C([*])=O"], 
        "num_reactants": 1, 
        "reaction_string": "[*:1]C(=O)-O-C([*:2])=O>>[*:1]C(=O)C#N", 
        "RXN_NUM": 31
        },
    "32_Acid_Anhydride_To_Azide":     {
        "reaction_name": "32_Acid_Anhydride_To_Azide",
        "example_rxn_product": "[N-]=[N+]=NC(=O)C1CCCCC1", 
        "example_rxn_reactants": ["C1CCC(CC1)C(=O)OC(=O)C2CCCCC2"], 
        "functional_groups": ["Acid_Anhydride"], 
        "group_smarts": ["[*]C(=O)-O-C([*])=O"], 
        "num_reactants": 1, 
        "reaction_string": "[*:1]C(=O)-O-C([*:2])=O>>[*:1]C(=O)-N=[N+]=[N-]", 
        "RXN_NUM": 32
        },
...
All_Rxns_reactions =     {
        ...
        "26_Acid_Anhydride_and_Amine":     {
            "reaction_name": "26_Acid_Anhydride_and_Amine",
            "example_rxn_product": "O=C1CN(C(=O)C2CCCCC2)C(=O)O1", 
            "example_rxn_reactants": ["C1CCC(CC1)C(=O)OC(=O)C2CCCCC2", "O=C1CNC(=O)O1"], 
            "functional_groups": ["Acid_Anhydride", "Amine_2R"], 
            "group_smarts": ["[*]C(=O)-O-C([*])=O", "[#7;$([#7;H3+,H2R0X1]-[#6]),$([#7&!H3;H1R1X3](:,-[#6R1]):,-[#6R1,#7R1]),$([#7&!H3;H2]-[#6]),$([#7&!H3;H0R1X2](:,-[#6R1;X3H1]):,-[#6R1X3H1]),$([#7&!H3;H0R1X2](:,-[#6R1;X3]):,-[#7R1X3]),$([#7&!H3;H1R0X3](-[#6])-[#6R0])]"], 
            "num_reactants": 2, 
            "reaction_string": "[*:1]C(=O)-O-C([*:4])=O.[#7;$([#7;H3+,H2R0X1]-[#6]),$([#7&!H3;H1R1X3](:,-[#6R1]):,-[#6R1,#7R1]),$([#7&!H3;H2]-[#6]),$([#7&!H3;H0R1X2](:,-[#6R1;X3H1]):,-[#6R1X3H1]),$([#7&!H3;H0R1X2](:,-[#6R1;X3]):,-[#7R1X3]),$([#7&!H3;H1R0X3](-[#6])-[#6R0]):2]>>[*:1]C(=O)-[#7+0:2]", 
            "RXN_NUM": 26
            },
        "27_Acid_Anhydride_and_Alcohol":     {
            "reaction_name": "27_Acid_Anhydride_and_Alcohol",
            "example_rxn_product": "O=C(OCCCF)C1CCCCC1", 
            "example_rxn_reactants": ["C1CCC(CC1)C(=O)OC(=O)C2CCCCC2", "FCCC(O)"], 
            "functional_groups": ["Acid_Anhydride", "Alcohol"], 
            "group_smarts": ["[*]C(=O)-O-C([*])=O", "[#6&$([CR0,R1X3,R1X4])&!$([#6](=,-[OR0,SR0])[OR0])]-[OR0;H1,-]"], 
        ...
        "28_Acid_Anhydride_and_Thiol":     {
            "reaction_name": "28_Acid_Anhydride_and_Thiol",
            "example_rxn_product": "O=C([O-])OC(=O)CCSC(=O)C1CCCCC1", 
            "example_rxn_reactants": ["C1CCC(CC1)C(=O)OC(=O)C2CCCCC2", "O=C([O-])OC(=O)CCS"], 
            "functional_groups": ["Acid_Anhydride", "Thiol_1R"], 
            "group_smarts": ["[*]C(=O)-O-C([*])=O", "[#6&$([CR0,R1X3,R1X4])&!$([#6](=,-[OR0,SR0])[SR0])]-[SR0;H1,-]"], 
        ...
        "29_Acid_Anhydride_To_Cyanide":     {
            "reaction_name": "29_Acid_Anhydride_To_Cyanide",
            "example_rxn_product": "N#CC(=O)C1CCCCC1", 
            "example_rxn_reactants": ["C1CCC(CC1)C(=O)OC(=O)C2CCCCC2"], 
            "functional_groups": ["Acid_Anhydride"], 
            "group_smarts": ["[*]C(=O)-O-C([*])=O"], 
        ...
        "30_Acid_Anhydride_To_Azide":     {
            "reaction_name": "30_Acid_Anhydride_To_Azide",
            "example_rxn_product": "[N-]=[N+]=NC(=O)C1CCCCC1", 
            "example_rxn_reactants": ["C1CCC(CC1)C(=O)OC(=O)C2CCCCC2"], 
            "functional_groups": ["Acid_Anhydride"], 
            "group_smarts": ["[*]C(=O)-O-C([*])=O"], 
