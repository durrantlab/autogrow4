"""
Class for filtering out a molecule that does not have Cationic interactions against a given receptor at specific
residues.

This module uses the ProLIF library to get the Cationic interactions. To pass the filter, a molecule must have each
Cationic interaction specified as input.
...
class CationicInteractionFilter(SpecificInteractionFilter):
    """
    Class for filtering out a molecule that does not have Cationic interactions against a given receptor at specific
    residues.
    ...
    ProLIF library is available at https://github.com/chemosim-lab/ProLIF
    """
    fingerprints = prolif.Fingerprint(["Cationic"])
