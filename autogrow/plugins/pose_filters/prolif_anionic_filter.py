"""
Class for filtering out a molecule that does not have Anionic interactions against a given receptor at specific
residues.

This module uses the ProLIF library to get the Anionic interactions. To pass the filter, a molecule must have each
Anionic interaction specified as input.
...
class AnionicInteractionFilter(SpecificInteractionFilter):
    """
    Class for filtering out a molecule that does not have Anionic interactions against a given receptor at specific
    residues.
    ...
    ProLIF library is available at https://github.com/chemosim-lab/ProLIF
    """
    fingerprints = prolif.Fingerprint(["Anionic"])
