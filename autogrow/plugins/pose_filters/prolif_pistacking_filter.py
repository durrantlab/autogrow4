        ...
        return (
            ...
            [
                ArgumentVars(
                    ...
                    type=str,
                    default=False,
                    help="Comma-separated list of specific residues in a receptor that should have PiStacking "
                         "interactions with respect to a docked molecule. For example, --PiStackingInteractionFilter "
                         "TYR907",
                )
            ],
        )
