"""
Class for filtering out a molecule that does not have VDW interactions against a given receptor at specific
residues.

This module uses the ProLIF library to get the VDW interactions. To pass the filter, a molecule must have each
VDW interaction specified as input.
...
class VDWInteractionFilter(SpecificInteractionFilter):
    """
    Class for filtering out a molecule that does not have VDW interactions against a given receptor at specific
    residues.
    ...
    ProLIF library is available at https://github.com/chemosim-lab/ProLIF
    """
    fingerprints = prolif.Fingerprint(["VdWContact"])
