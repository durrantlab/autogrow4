...
def get_all_subclasses(base_class):
    ...
    """
    Method for getting all child classes from a parent object.
    Taken from:
    ...
    Returns
    :returns: class all_subclasses: A list of classes representing the child classes of the base_class
    """
    all_subclasses = []
