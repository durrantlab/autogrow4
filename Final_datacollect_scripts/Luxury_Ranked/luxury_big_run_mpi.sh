#!/bin/bash
#SBATCH --job-name=PARP_luxury_Run_0
#SBATCH --output=/bgfs/jdurrant/jspiegel/Luxury_Run/Ranked_Lux/PARP_luxury_Run_0.conf.out
...
highest_folder="/bgfs/jdurrant/jspiegel/Luxury_Run/Ranked_Lux/"
