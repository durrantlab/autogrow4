...
file_path = "/bgfs/jdurrant/jspiegel/autogrow4/Final_datacollect_scripts/Benchmarks/submit_autogrow313_benchmark.sh"
...
for x in range(0, 24):
    ...
    new_file = out_folder + "submit_autogrow313_benchmark_Run_{}.sh".format(str(x))
