...
do
    ...
    echo "START Autogrow 4.0 Run number $i RUN USING with Rank_QVINA2_5"
    ...
    ~/miniconda3/envs/py37/bin/python -m mpi4py /bgfs/jdurrant/jspiegel/autogrow4/RunAutogrow.py \
        ...
        --source_compound_file /bgfs/jdurrant/jspiegel/autogrow4/source_compounds/PARPI_BRICS_frags.smi \
