#!/bin/bash
#SBATCH --job-name=PARPi_lead_opt_Run_0
#SBATCH --output=/bgfs/jdurrant/jspiegel/PARPi_leadopt/PARP_Run_0.conf.out
...
# run precache
~/miniconda3/envs/py37/bin/python /bgfs/jdurrant/jspiegel/autogrow/RunAutogrow.py -c
...
do
    ...
    ~/miniconda3/envs/py37/bin/python -m mpi4py /bgfs/jdurrant/jspiegel/autogrow/RunAutogrow.py \
        ...
        --source_compound_file /bgfs/jdurrant/jspiegel/autogrow/source_compounds/PARPI_BRICS_frags.smi \
